...
db-load-fixtures: wait-db db-drop db-create
	...
	@$(EXEC_DB) "mysql --user=root --password=root < /home/app/dump/eda_bottle_inventory.sql"
	@$(EXEC_MONGODB) mongorestore --drop --db eda_bottle_inventory /home/app/dump/documents/eda_bottle_inventory

## Load database from dump test
db-load-fixtures-test: wait-db db-drop-test db-create-test
	@echo "\nLoading fixtures from dump...\e[0m"
	@$(EXEC_DB) "mysql --user=root --password=root < /home/app/dump/eda_bottle_inventory_test.sql"
	@$(EXEC_MONGODB) mongorestore --drop --db eda_bottle_inventory_test /home/app/dump/documents/eda_bottle_inventory_test
...
db-reload-fixtures: env-dev wait-db db-reload-schema
	...
	@echo "\nCreating dump...\e[0m"
	@$(EXEC_DB) "mysqldump --user=root --password=root --databases eda_bottle_inventory > /home/app/dump/eda_bottle_inventory.sql"
	@$(EXEC_MONGODB) mongodump --db eda_bottle_inventory --out /home/app/dump/documents
...
db-reload-fixtures-test: env-test wait-db db-reload-schema-test
	...
	@echo "\nCreating dump...\e[0m"
	@$(EXEC_DB) "mysqldump --user=root --password=root --databases eda_bottle_inventory_test > /home/app/dump/eda_bottle_inventory_test.sql"
	@$(EXEC_MONGODB) mongodump --db eda_bottle_inventory_test --out /home/app/dump/documents
...
yaml-linter:
	...
	@$(EXEC_SYMFONY) lint:yaml src/ config/ fixtures/ docker* --exclude="config/deploy.yml"
